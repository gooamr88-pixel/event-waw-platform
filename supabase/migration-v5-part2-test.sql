...
-- Uses DO+EXECUTE to bypass Supabase SQL Editor parser bug with INTO variables
-- Run this AFTER Part 1 schema changes

-- Drop old versions (handles return type changes)
